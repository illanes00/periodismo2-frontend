...
export async function MobileTrending() {
  ...
  return (
    <div id="tendencias" className="mb-8 scroll-mt-32 lg:hidden">
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-none">
        {topics.slice(0, 10).map((topic) => (
          <Link
            ...
            className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-neutral-200 bg-neutral-50 px-3 py-1.5 text-sm font-medium text-neutral-700 transition hover:border-brand-300 hover:bg-brand-50 hover:text-brand-700 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:border-brand-800 dark:hover:bg-brand-900/30 dark:hover:text-brand-400"
          >
